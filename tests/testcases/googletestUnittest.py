...
expectedZipName = "googletesttestcase.zip"


description = "googletest description"
title = "googletest testcase"
filesize = "3333"
language = "en"
prog_lang = "cpp"


class GoogletestUnittest(zipFileTest.ZipFileTest):

    def setUp(self):
        print("setup Googletest Unittest")
        zipFileTest.ZipFileTest.setUp(self, 'cpp', 'cpp')
    ...
    def test_input(self):
        ...
        editor.set_filename(0, "file0.cpp")
        editor.set_filename(1, "file1.cpp")
        editor.set_filename(2, "file1.h")
        editor.set_filename(3, "Makefile")
        # set filename for file 4 later
        editor.set_filename(5, "file2.cpp")

        # fill file comment (0-based)
        editor.set_file_comment(0, "comment for file file0.cpp")
        editor.set_file_comment(1, "comment for file file1.cpp")
        ...
        editor.set_file_comment(5, "comment for file file2.cpp")

        # set file class
        editor.set_code_skeleton("code skeleton")
        #editor.add_download_file()
        editor.set_download_filename("file1.cpp", 0)
        ...
        editor.set_filename(4, "file4.cpp")
        editor.set_file_comment(4, "comment for file file4.cpp")
        ...
        editor.add_file_to_model_solution(1, 1) # file1.cpp
        ...
        editor.set_test_title(counter_test_index, "Googletest Test #1")
        editor.add_test_file(counter_test_index)
        editor.set_test_description(counter_test_index, "googletest description # 1")
